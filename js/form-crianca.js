(function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        const sexoSelecionado = form.querySelector('input[name="sexo"]:checked');
    ...
    function calcularIMC() {
        ...
        const classificacao = classificarIMCCrianca(imc, idade, sexo);
    ...
    function mostrarResultado(nome, imc, classificacao) {
        ...
        if (imc < 14) {
            porcentagem = Math.max(0, ((imc - 10) / 4) * 20);
        } else if (imc < 19) {
            porcentagem = 20 + ((imc - 14) / 5) * 40;
        } else if (imc < 22) {
            porcentagem = 60 + ((imc - 19) / 3) * 20;
        } else {
            porcentagem = 80 + Math.min(((imc - 22) / 8) * 20, 20);
        }
                ...
                <div class="resultado-body p-4">
                    ...
                    <div class="alert alert-warning border-0" role="alert">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <strong>Importante:</strong> Esta é uma avaliação baseada em percentis da OMS. 
                                Consulte um pediatra para avaliação completa.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" 
                                ...
                                onclick="document.getElementById('formCrianca').reset(); document.getElementById('resultado').style.display='none'; document.getElementById('formCrianca').classList.remove('was-validated');"
