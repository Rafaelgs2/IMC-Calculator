(function() {
    ...
    const form = document.getElementById('formAdulto');
    ...
    function calcularIMC() {
        ...
        const classificacao = classificarIMCAdulto(imc);
    ...
    function mostrarResultado(nome, imc, classificacao) {
        ...
        if (imc < 18.5) {
            porcentagem = Math.max(0, ((imc - 10) / 8.5) * 20);
        } else if (imc < 25) {
            porcentagem = 20 + ((imc - 18.5) / 6.5) * 40;
        } else if (imc < 30) {
            porcentagem = 60 + ((imc - 25) / 5) * 20;
        } else {
                ...
                <div class="resultado-body p-4">
                    ...
                    <div class="alert alert-warning border-0" role="alert">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <strong>Importante:</strong> Esta é uma avaliação baseada no cálculo de IMC padrão. 
                                Consulte um médico ou nutricionista para avaliação completa.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" 
                                ...
                                onclick="document.getElementById('formAdulto').reset(); document.getElementById('resultado').style.display='none'; document.getElementById('formAdulto').classList.remove('was-validated');"
